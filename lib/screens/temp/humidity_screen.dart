          ...
          child:  Column(
            children: [
                                    ...
                                    children: [
                                      ...
                                      tempHumidForcast == null
                                        ...
                                        size: 35.0,
                                          ...
                                          : Text(
                                        '${tempHumidForcast?.data.humidity ?? 'N/A'}%',
                                        style: TextStyle(
                                            fontSize: 25,
                                            fontWeight: FontWeight.bold,
                                            color: Colors.black),
                      ...
                      child: Row(
                          ...
                          children: tempHumidForcast?.data.forecastData.isNotEmpty ?? false
                            ...
                            return Padding(
                              ...
                              child: Container(
                                width: ScreenSizeUtil.getWidth(context) * 0.31,
                              ...
                              : [
                      // If no data, show CircularProgressIndicator
                      Padding(
                      padding: EdgeInsets.symmetric(horizontal: 10),
                      child: Container(
                        width: ScreenSizeUtil.getWidth(context) * 0.31,
              ...
              barBg: ClrUtils.darkblue,
                                  percentage: tempHumidForcast?.data.humidity ?? 0,                                ),
                                SizedBox(
                                  height: 20,
                                ),
                                Text(
